...
<a href="{{ route('detail__invoices.index') }}">detail__invoices List</a>
</div>

<h1>Edit detail__invoices</h1>
@if(session('message'))
<div style="color: green;">{{ session('message') }}</div>
@endif
<form action="{{ route('detail__invoices.update', $detail__invoice) }}" method="get">
@csrf
<div style="margin-bottom: 1em;">
