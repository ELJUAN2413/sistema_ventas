...
<?php endif; ?>
<form action="<?php echo e(route('cities.create')); ?>" method="post">
<?php echo csrf_field(); ?>
<div style="margin-bottom: 1em;">
<label for="nombre">nombre</label>
<input type="text" name="nombre" id="nombre" placeholder="Enter cities" values="<?php echo e(old('nombre')); ?>">
...
<option
<?php if($departament->id === (int)old('departament_id')): ?>
selected
<?php endif; ?>
...
<?php /**PATH C:\crud\crud\resources\views/cities/create.blade.php ENDPATH**/ ?>