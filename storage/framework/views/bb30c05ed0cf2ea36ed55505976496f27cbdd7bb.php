<div style="margin-bottom: 1em;">
    <a href="<?php echo e(route('detail_invoices.index')); ?>">detail_invoices List</a>
  </div>
  detail_invoices
  ...
  <?php endif; ?>
  <form action="<?php echo e(route('detail_invoices.create')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div style="margin-bottom: 1em;">
...
<?php /**PATH C:\crud\crud\resources\views/detail_invoices/create.blade.php ENDPATH**/ ?>