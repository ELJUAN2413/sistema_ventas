<div style="margin-bottom: 1em;">
    <a href="<?php echo e(route('customers.index')); ?>">customers List</a>
  </div>
employee
  ...
  <?php endif; ?>
  <form action="<?php echo e(route('customers.create')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div style="margin-bottom: 1em;">
...
<?php /**PATH C:\crud\crud\resources\views/customers/create.blade.php ENDPATH**/ ?>